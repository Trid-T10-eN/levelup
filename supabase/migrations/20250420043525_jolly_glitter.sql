/*
  # Update roadmap tables and policies
  
  1. Tables
    - Ensures roadmap_levels and user_progress tables exist
...
DO $$ BEGIN
  DROP POLICY IF EXISTS "Roadmap levels are viewable by authenticated users" ON roadmap_levels;
  DROP POLICY IF EXISTS "Authenticated users can create roadmap levels" ON roadmap_levels;
  DROP POLICY IF EXISTS "Users can view own progress" ON user_progress;
  DROP POLICY IF EXISTS "Users can update own progress" ON user_progress;
  DROP POLICY IF EXISTS "Users can mark levels as complete" ON user_progress;
EXCEPTION
